"""Trace Qwen3-Coder-480B performance with different TP sizes and MoE backends."""
...
class TraceQwen3Coder480B(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.base_url = DEFAULT_URL_FOR_TEST
        cls.runner = NightlyBenchmarkRunner(
            PROFILE_DIR, "Qwen3-Coder-480B Performance Traces", cls.base_url
        )
        cls.runner.setup_profile_directory()
        cls.results_manager = TraceResultsManager(PROFILE_DIR)

    def test_qwen3_coder_480b_configs(self):
        """Test Qwen3-Coder-480B with different TP/EP/MoE configurations."""
        ...
        for tp_size, ep_size, quant_backend_pairs in CONFIGS:
            for (
                ...
                config_name = f"qwen3-coder-480b {variant}"
                ...
                if not primary_success and fallback_backend is not None:
                    ...
                    fallback_config_name = f"qwen3-coder-480b {fallback_variant}"
