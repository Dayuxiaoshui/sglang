"""Trace Kimi-K2-Thinking performance with different TP sizes and MoE backends."""
...
class TraceKimiK2(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.base_url = DEFAULT_URL_FOR_TEST
        cls.runner = NightlyBenchmarkRunner(
            PROFILE_DIR, "Kimi-K2-Thinking Performance Traces", cls.base_url
        )
        cls.runner.setup_profile_directory()
        cls.results_manager = TraceResultsManager(PROFILE_DIR)

    def test_kimi_k2_configs(self):
        """Test Kimi-K2-Thinking with different TP/EP/MoE configurations."""
